...
- [ ] CR solution:<br>- [x] in Booking class, add @ManyToMany rs to List<user><br>- [x] update constructor booking<br>- [x] add boolean for isShareable.<br>- [x] add boolean is shareable in booking request class<br>- [x] in service layer, add user to list and then save the booking <br>- [ ] update tests<br><br>- [ ] new endpoint to book onto already created bookings. will need user id and booking id.<br>- [ ] service must check again if booking isShareabl<br><br>- [ ] update repository for find all by user id
